const ProductCard = ({ image, price, title }) => {
  return (
    <div className="flex flex-col gap-1 h-full group">
      <div className="h-48 relative flex items-center justify-center p-4 border border-color/50 bg-white cursor-pointer group-hover:border-2 min-[425px]:h-56 sm:h-60 xl:h-80">
        <img
          src={image}
          alt={`${title}-img`}
